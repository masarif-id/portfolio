                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
                        {lutPacks.map((pack, index) => (
                            <Card key={index} className='p-8 text-center hover:shadow-xl transition-shadow duration-300'>
                                ...
                                <div className='mb-6'>
                                    <span className='text-3xl font-bold text-pink-600 dark:text-pink-400'>{pack.price}</span>
                                </div>
                                <a
                                    href='https://store.masarif.id/lut'
                                    target='_blank'
                ...
                <Container className='py-16'>
                    <Card className='p-12 text-center bg-pink-600 dark:bg-pink-700 text-white'>
                        ...
                        <a
                            ...
                            target='_blank'
                            rel='noopener noreferrer'
                            className='group inline-flex items-center justify-center gap-3 px-8 py-4 bg-white text-pink-600 rounded-full font-medium text-lg transition-all duration-300 hover:shadow-lg hover:scale-105'>
                            <FaDownload />
                            Shop All LUTs
                            <FaArrowRight className='-rotate-45 transition-transform duration-300 group-hover:rotate-0' />
                        </a>
